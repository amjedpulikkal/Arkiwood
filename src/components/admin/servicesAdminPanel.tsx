...
// const ServicesAdminPanel = ({ open, services, setSelectServices }) => {
...
//       toast.promise(fetch(`/api/services/deleteService?serviceId=${id}`), {
//           loading: "Loading...",
//           success: () => {
//             fetchData()
...
//                       </button>
//                       <button onClick={()=>setSelectServices(service)} className="p-2 bg-white/10 hover:bg-white/20 rounded-lg text-white transition-colors">
...
//                       >
//                         <Image alt={image} src={image.image_url} fill />
//                       </div>
//                     ))}
//                   </div>
//                 </div>
